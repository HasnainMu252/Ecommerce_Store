  ...
  return (
    <div>
      ...
      <div className="text-center">
                <h1 className="text-3xl text-gray-800 font-semibold m-5 underline text-4xl ">
                    Featured Products
       ...
       <section className="m-10 mt-12 mx-auto px-4 max-w-screen-xl md:px-8">
            <div className="text-center">
                <h1 className="text-3xl text-gray-800 font-semibold m-5 underline text-4xl ">
                    Blog Post
                </h1>
       ...
       <section className="py-28 bg-purple-200">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <h3 className="text-black-300 text-3xl font-semibold sm:text-4xl">
