...
import {Link } from "react-router-dom";
 ...
 const Header =() => {
    ...
    return (
        <nav className="bg-white border-b w-full md:static md:text-sm md:border-none my-4">
          <Fade top cascade>
            <div style={{borderBottom:"4px solid #9618f2"}} className="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
                <div className="flex items-center justify-between py-3 md:py-5 md:block">
                    <a  style={{fontSize:"24px",fontFamily:'fantasy',textDecoration:"underline",textShadow:'inherit',color:'#9618f2'}} href="javascript:void(0)">
